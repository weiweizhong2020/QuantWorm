...
Original from: package com.horstmann.corejava;
Added: setDefaultInsets() method (Aleman-Meza)
...
/**
   ...
   */
   ...
   /**
    * Sets default insets (currently of distance = 3)
    * @return  this object for further modification
    */
   public GBC setDefaultInsets() {
	   return setInsets( 3, 3, 3, 3 );
   }
